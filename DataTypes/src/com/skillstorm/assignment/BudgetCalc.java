...
public class BudgetCalc {
	...
	public static void main(String[] args) {
		...
		System.out.print("Let's get started! How much do you make each month?");
		double income = scanner.nextDouble();
		
		System.out.println("Great. Now let's switch gears to your expenses.");
		System.out.print("How much is your monthly rent or mortgage?");
		double housing = scanner.nextDouble();
		
		System.out.print("What are your combined monthly utility costs?");
		double utilities = scanner.nextDouble();
		
		System.out.print("How much is your combined car payment and insurance?");
		double transport = scanner.nextDouble();
		
		double savings = income - housing - utilities - transport;
		
		if(savings <= 0.00) {
			System.out.print("You're in the negative! Time for some budget cuts! You are at a net loss of " + savings + "!");
		}else {
